...
/**
 * Class IndexDeleteRawCommand
 * @package IndexEngine\IO\Command
 * @author Benjamin Perche <benjamin@thelia.net>
 */
class IndexDeleteRawCommand extends IndexEngineCommand
{
    protected function configure()
    {
        ...
        $this
            ->setName("index:delete:raw")
            ->setDescription("Deletes an index with a driver configuration")

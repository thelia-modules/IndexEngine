...
DROP TABLE IF EXISTS `index_engine_index`;

CREATE TABLE `index_engine_index`
(
...
DROP TABLE IF EXISTS `index_engine_driver_configuration`;
...
DROP TABLE IF EXISTS `index_engine_index_template`;

CREATE TABLE `index_engine_index_template`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `visible` TINYINT DEFAULT 0 NOT NULL,
    `code` VARCHAR(255) NOT NULL,
...
DROP TABLE IF EXISTS `index_engine_index_version`;

CREATE TABLE `index_engine_index_version`
(
    `id` INTEGER NOT NULL,
    `visible` TINYINT DEFAULT 0 NOT NULL,
    `code` VARCHAR(255) NOT NULL,
...
DROP TABLE IF EXISTS `index_engine_index_template_version`;

CREATE TABLE `index_engine_index_template_version`
(
    `id` INTEGER NOT NULL,
    `visible` TINYINT DEFAULT 0 NOT NULL,
    `code` VARCHAR(255) NOT NULL,

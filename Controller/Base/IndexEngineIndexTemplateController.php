 ...
 * @author TheliaStudio
 */
class IndexEngineIndexTemplateController extends AbstractCrudController
{
    public function __construct()
    {
        parent::__construct(
            ...
            IndexEngineIndexTemplateEvents::CREATE,
            IndexEngineIndexTemplateEvents::UPDATE,
            IndexEngineIndexTemplateEvents::DELETE,
            IndexEngineIndexTemplateEvents::TOGGLE_VISIBILITY,
            null,
            "IndexEngine"
        );
    }
    ...
    {
        return $this->createForm("index_engine_index_template.create");
    }
    ...
    protected function getUpdateForm($data = array())
    {
        ...
        return $this->createForm("index_engine_index_template.update", "form", $data);
    }
    ...
    {
        $event = new IndexEngineIndexTemplateEvent();
    ...
    protected function getDeleteEvent()
    {
        ...
        $event->setId($this->getRequest()->request->get("index_engine_index_template_id"));
    ...
    {
        return $event->getIndexEngineIndexTemplate();
    }
    ...
    {
        return IndexEngineIndexTemplateQuery::create()
            ->findPk($this->getRequest()->query->get("index_engine_index_template_id"))
        ;
    }
    ...
    protected function renderListTemplate($currentOrder)
    {
        ...
        return $this->render("index-engine-index-templates");
    }
    ...
    protected function renderEditionTemplate()
    {
        $this->getParserContext()
            ->set(
                "index_engine_index_template_id",
                $this->getRequest()->query->get("index_engine_index_template_id")
            )
        ;

        return $this->render("index-engine-index-template-edit");
    }
    ...
    {
        $id = $this->getRequest()->query->get("index_engine_index_template_id");
    ...
    {
        return new ToggleVisibilityEvent($this->getRequest()->query->get("index_engine_index_template_id"));
    }
}

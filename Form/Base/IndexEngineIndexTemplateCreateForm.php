 ...
 * @author TheliaStudio
 */
class IndexEngineIndexTemplateCreateForm extends BaseForm
{
    const FORM_NAME = "index_engine_index_template_create";
    ...
    {
        return array(
            "visible" => "index_engine_index_template_visible",
            "code" => "index_engine_index_template_code",
            "title" => "index_engine_index_template_title",
            "entity" => "index_engine_index_template_entity",
            "serialized_columns" => "index_engine_index_template_serialized_columns",
            "serialized_condition" => "index_engine_index_template_serialized_condition",
            "index_engine_driver_configuration_id" => "index_engine_index_template_index_engine_driver_configuration_id",
        );
    }
}

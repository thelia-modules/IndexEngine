...
namespace IndexEngine\Form\Transformer;
 ...
 * @package IndexEngine\Form\Transformer
 * @author Benjamin Perche <benjamin@thelia.net>
 */
class IndexMappingTransformer implements DataTransformerInterface
{
    /**
    ...
    public function reverseTransform($value)
    {
        ...
        foreach ($value as $entry) {
            ...
            $builtData[$entry["column"]] = $entry["type"];
        }

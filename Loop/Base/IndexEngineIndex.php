 ...
 * @author TheliaStudio
 */
class IndexEngineIndex extends BaseLoop implements PropelSearchLoopInterface
{
    ...
    {
        /** @var \IndexEngine\Model\IndexEngineIndex $entry */
    ...
    {
        $query = new IndexEngineIndexQuery();
